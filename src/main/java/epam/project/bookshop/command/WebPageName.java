...
public final class WebPageName {
    ...
    public static final String SIGNUP_PAGE = "/pages/registration.jsp";
    ...
    public static final String USERS_UPDATE_PAGE = "/pages/user/user_update.jsp";
    public static final String USER_PROFILE = "/pages/user/user_profile.jsp";
    public static final String USER_UPDATE_STATUS = "/pages/admin/user_update_status.jsp";
    public static final String USER_INFORMATION_PAGE = "/pages/user/user_information.jsp";
    public static final String USER_ORDER_PAGE = "/pages/user/user_orders.jsp";
    public static final String GENRE_PAGE = "/pages/admin/genre.jsp";
    public static final String GENRE_UPDATE_PAGE = "/pages/admin/genre_update.jsp";
    public static final String GENRE_CREATE_PAGE = "/pages/admin/genre_create.jsp";
