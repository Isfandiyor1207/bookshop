        ...
        <div class="main-content">
            ...
            <form method="post" autocomplete="on" action="${pageContext.request.contextPath}/controller">
                ...
                <div class="box">
                    ...
                    <div class="fr">
                        <label class="fl fontLabel"> <fmt:message key="label.author_fio"/>: </label>
                        <label>
                            <input type="text" name="fio" placeholder="Full name"
                                   class="textBox" autofocus="on" value="">
                ...
                <div><small style="color: red; text-transform: none">${author_full_name_error}</small></div>
