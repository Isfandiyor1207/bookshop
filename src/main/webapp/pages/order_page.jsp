...
<%--                </div>--%>
<%--                <button type="submit" name="id" value="${book_info.id}" class="btn btn-primary">Rate</button>--%>
<%--            </form>--%>
<%--        </div>--%>
...
<%--                    <button class="btn btn-success" type="submit" name="book_id" value="${book_info.id}">Buy</button>--%>
<%--                </form>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
