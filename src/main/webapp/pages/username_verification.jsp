        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    ...
                    <a href="${pageContext.request.contextPath}/pages/registration.jsp" class="signup-image-link"><fmt:message key="label.forgot.password"/></a>
                </div>
                ...
                <div class="signin-form">
                    ...
                    <form action="${pageContext.request.contextPath}/controller" class="register-form" id="login-form">
                        ...
                        <b><small style="color: red">${send_password_error}</small></b>
